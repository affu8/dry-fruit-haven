...
export default function BrandIntroSection() {
  ...
  return (
    <section ref={ref} className="py-32 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-rose-pink/5 to-transparent" />
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="text-rose-pink font-medium mb-4 block">About Welcome Dry Fruit House</span>
            ...
            <div className="grid grid-cols-3 gap-6">
              {[
                ...
                <div key={stat.label} className="text-center">
                  <div className="text-3xl font-display font-bold text-rose-pink">{stat.val}</div>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-pink/15 to-primary/20 flex items-center justify-center mb-4">
                  <feature.icon size={22} className="text-rose-pink" />
                </div>
