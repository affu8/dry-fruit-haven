  ...
  return (
    <group ref={groupRef}>
      {dryFruits.map((fruit, index) => {
        switch (fruit.type) {
          case 'almond':
            return <Almond key={index} position={fruit.position} color={fruit.color} />;
          case 'cashew':
            return <Cashew key={index} position={fruit.position} color={fruit.color} />;
          case 'pistachio':
            return <Pistachio key={index} position={fruit.position} color={fruit.color} />;
          case 'walnut':
            return <Walnut key={index} position={fruit.position} color={fruit.color} />;
          default:
            return null;
        }
      })}
